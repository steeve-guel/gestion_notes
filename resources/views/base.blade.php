        ...
        <div class="col-md-2 themed-grid-col">
            <div class="flex-shrink-0 p-3" style="width: 280px;border-right: 1px solid #c1c1c1;height:99.5vh;">
                ...
                <ul class="list-unstyled ps-0">
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#notes-collapse" aria-expanded="false">
                            Note
                        </button>
                        <div class="collapse" id="notes-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="{{url('/notes/newNote')}}" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Ajout d'une note</a></li>
                                <li><a href="{{url('/notes/')}}" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Detail sur les notes</a></li>
                            </ul>
                        </div>
                    </li>
